...
namespace SendbirdSDK
{
	...
	interface SBDUser : INativeObject
	{
	...
	[BaseType (typeof(NSObject))]
    interface SBDBaseMessage : INativeObject
	{
    ...
    interface SBDMember : INativeObject
	{
	...
	interface SBDChannelDelegate
	{
		...
		void ChannelDidReceiveMessage (SBDBaseChannel sender, SBDBaseMessage message);
		...
		void ChannelDidUpdateMessage (SBDBaseChannel sender, SBDBaseMessage message);
		...
		void ChannelCreatedMetaData (SBDBaseChannel sender, [NullAllowed] NSDictionary<NSString, NSString> createdMetaData);
		...
		void ChannelUpdatedMetaData (SBDBaseChannel sender, [NullAllowed] NSDictionary<NSString, NSString> updatedMetaData);
		...
		void ChannelCreatedMetaCounters (SBDBaseChannel sender, [NullAllowed] NSDictionary<NSString, NSNumber> createdMetaCounters);
		...
		void ChannelUpdatedMetaCounters (SBDBaseChannel sender, [NullAllowed] NSDictionary<NSString, NSNumber> updatedMetaCounters);
		...
		void ChannelDeletedMetaCountersKeys (SBDBaseChannel sender, [NullAllowed] string[] deletedMetaCountersKeys);
	}
	...
	interface SBDBaseChannel
	{
		...
		SBDMessageListQuery CreateMessageListQuery ();
	...
	interface SBDGroupChannel : INativeObject
	{
		...
		SBDGroupChannelListQuery CreateMyGroupChannelListQuery ();
        ...
        NSDictionary<NSString, NSDictionary<NSString, NSObject>> ReadStatus();
	...
	[BaseType (typeof(SBDBaseChannel))]
    interface SBDOpenChannel : INativeObject
	{
	...
	interface SBDMain
	{
        ...
        NSDictionary ConnectionDelegatesDictionary { get; }
		...
		NSDictionary ChannelDelegatesDictionary { get; }
		...
		NSMutableArray BackgroundTaskBlock { get; set; }
        ...
        void PerformComletionHandlerDelegateQueueBlock ([NullAllowed] Action block);
		...
		SBDUserListQuery CreateBlockedUserListQuery ();
